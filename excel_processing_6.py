...
def process_excel_data_6(df_uploaded, excel_filename, dynamic_columns):
    ...
    for index, row in df_uploaded.iterrows():
        ...
        # 転記位置を決定（'経常損益'と'特別利益'の間）
        insert_row = find_row_for_insertion(sheet, '経常損益', '特別利益')
