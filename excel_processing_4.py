...
def process_excel_data_4(df_uploaded, excel_filename, dynamic_columns):
    ...
    for index, row in df_uploaded.iterrows():
        ...
        # 転記位置を決定（'営業損益'と'営業外利益'の間）
        insert_row = find_row_for_insertion(sheet, '営業損益', '営業外利益')
